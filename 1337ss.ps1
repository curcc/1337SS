...
Write-Host -ForegroundColor Magenta "                                                   ╚═╝╚═════╝ ╚═════╝    ╚═╝";
Write-Host "";
Write-Host -ForegroundColor Magenta "                                           ScreenShare 1337 - " -NoNewLine
Write-Host -ForegroundColor Magenta "discord.gg/lostfiles";
Write-Host "";;
...
$Bam = Foreach ($Sid in $Users){$u++
        ...
        foreach($rp in $rpath){
           ...
           Write-Host -ForegroundColor Gray "Extracting " -NoNewLine
